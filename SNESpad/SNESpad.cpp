/* this version of SNESpad is modified for SNEStoCDi - https://github.com/anarterb/SNEStoCDi - mods by Laurent Berta 2016 */
...
// constructor
SNESpad::SNESpad(uint8_t strobe, uint8_t clock, uint8_t data)
  : m_strobe (strobe),
  m_clock (clock),
  m_data (data)
  {
...
uint16_t SNESpad::shiftin(void)
{
  uint16_t ret = digitalRead(m_data);
  delayMicroseconds(12);
